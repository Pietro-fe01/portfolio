    ...
    <header>
        <div class="h-100 ms-container d-flex justify-content-between">
            <router-link :to="{ name: 'homepage' }" class="text-decoration-none text-white" @click="scrollPage('toTop')">
                <img src="https://raw.githubusercontent.com/Pietro-fe01/portfolio/master/src/assets/loghi/logo-pf.jpg" alt="" style="width: 70px;">
            </router-link>

            <h2 class="m-text-cursive">Portfolio</h2>
        </div>
    </header>
</template>
